...
const Contact = () => {
  ...
  return (
    ...
    <div className=" h-screen  mt-60">
      ...
      <form
        action=""
        className="border bg-rose-200 mr-10 mt-10 border-black shadow-lg gap-x-10 shadow-gray-500 h-[640px] w-[700px] p-[60px] ml-[490px]"
      >
        ...
        <button
          onClick={() => router.push("/")}
          className="hover:bg-blue-500 mt-28 p-4 bg-blue-400 w-[200px] rounded-md shadow-lg shadow-gray-500 font-serif border border-gray-500 hover:border-gray-500  font-bold text-3xl bg-gradient-to-tr from-violet-400 via-lime-400 to-amber-400"
        >
          Submit
        </button>
      </form>
